...
function PopupWithForm(props){
    ...
    return (
        <div className={props.isOpen ? `popup popup_open popup_type_${props.name}` : `popup popup_type_${props.name}`}>
            <div className="popup__container">
                <button className="popup__close-button" type="button" id="pup-close" onClick={props.onClose}></button> 
                <form className="popup__form popup__form_type_profile-edit" name="form" onSubmit={props.onSubmit}>
